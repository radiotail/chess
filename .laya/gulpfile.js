...
gulp.task("default", function () {
	return browserify({
		...
		debug: true,
		entries: ['src/User.ts', 'src/Main.ts', 'src/Board.ts', 'src/Book.ts', 'src/Evaluate.ts',
				  'src/Game.ts', 'src/Login.ts', 'src/Match.ts',
				  'src/Mess.ts', 'src/Search.ts', 'src/Situation.ts', 'src/Sound.ts',
				  'src/Zobrist.ts'],
		cache: {},
		packageCache: {}
	})
